...
Auto-generated log of planning, debugging, and review sessions from SCHEDULE.md.
Each entry corresponds to a time-stamped work session committed to the repository.
...
## 2025-04-02 4:28 PM — Task 13 (Sigmoid → Softmax Output)
**[Docs]** Update inline comments in modified files for Sigmoid → Softmax Output
...
## 2025-04-08 8:33 PM — Task 39 (requirements.txt)
**[Debug]** Inspect shapes/types/values in requirements.txt pipeline step
...
## 2025-04-09 3:22 PM — Task 39 (requirements.txt)
**[debug]** Fix dependency conflict between scipy and numpy versions
...
## 2025-04-16 11:13 AM — Task 22 (Early Stopping)
**[debug]** Fix restore_best_weights failing if no improvement at all
...
## 2025-04-16 4:28 PM — Task 22 (Early Stopping)
**[Debug]** Inspect shapes/types/values in Early Stopping pipeline step

## 2025-04-16 5:53 PM — Task 22 (Early Stopping)
**[Review]** Code-review Early Stopping implementation for edge cases
...
## 2025-04-19 6:22 PM — Task 23 (Model Checkpointing)
**[debug]** Fix path error: create models/ dir if not exists

## 2025-04-20 9:23 AM — Task 23 (Model Checkpointing)
**[test]** Assert checkpoint file exists after training completes
...
## 2025-04-21 3:07 PM — Task 23 (Model Checkpointing)
**[evaluate]** Load checkpoint and verify identical val accuracy
...
## 2025-04-24 12:33 PM — Task 24 (Training Curves Visualization)
**[evaluate.py]** Plot train and val curves on same axes with legend

## 2025-04-24 12:44 PM — Task 24 (Training Curves Visualization)
**[notebook]** Call plot_training_history after each training run
...
## 2025-04-25 12:07 PM — Task 24 (Training Curves Visualization)
**[evaluate.py]** Plot train and val curves on same axes with legend

## 2025-04-25 2:44 PM — Task 24 (Training Curves Visualization)
**[notebook]** Call plot_training_history after each training run

## 2025-04-25 2:53 PM — Task 24 (Training Curves Visualization)
**[test]** Assert PNG saved to results/ directory
...
## 2025-04-27 11:37 AM — Task 3 (Class Distribution Plot)
**[evaluate.py]** Write plot_class_distribution(y, title, save_path)

## 2025-04-27 1:44 PM — Task 3 (Class Distribution Plot)
...
## 2025-05-05 11:37 AM — Task 30 (Confusion Matrix)
**[evaluate.py]** Add normalization='true' option for row-normalized matrix
...
## 2025-05-06 5:03 PM — Task 30 (Confusion Matrix)
**[debug]** Fix label encoding mismatch (int vs one-hot) before calling

## 2025-05-06 5:19 PM — Task 30 (Confusion Matrix)
**[evaluate]** Identify most-confused class pairs from matrix
...
## 2025-05-10 3:07 PM — Task 4 (Hold-out Test Split)
...
## 2025-05-11 11:52 AM — Task 4 (Hold-out Test Split)
**[debug]** Fix stratify error if class has fewer samples than n_splits

## 2025-05-11 1:28 PM — Task 4 (Hold-out Test Split)
...
## 2025-05-12 11:29 AM — Task 4 (Hold-out Test Split)
**[test]** Assert split proportions within ±1% of target
...
## 2025-05-12 2:03 PM — Task 4 (Hold-out Test Split)
**[docs]** Document split ratios and reproducibility note in data.py
...
## 2025-05-15 3:38 PM — Task 5 (Git LFS / CSV Data Loading)
...
## 2025-05-16 4:28 PM — Task 5 (Git LFS / CSV Data Loading)
**[Test]** Write stub test for Git LFS / CSV Data Loading to define expected behavior

## 2025-05-16 5:19 PM — Task 5 (Git LFS / CSV Data Loading)
**[Debug]** Verify dev environment: imports, paths, configs for Git LFS / CSV Data Loading

## 2025-05-16 7:28 PM — Task 5 (Git LFS / CSV Data Loading)
**[Test]** Add parametrized pytest case for Git LFS / CSV Data Loading boundary conditions
...
## 2025-05-17 2:03 PM — Task 5 (Git LFS / CSV Data Loading)
**[test]** Test load_data() with and without CSV present

## 2025-05-17 2:44 PM — Task 5 (Git LFS / CSV Data Loading)
...
## 2025-05-18 11:52 AM — Task 5 (Git LFS / CSV Data Loading)
**[Test]** Run integration test: main.py with Git LFS / CSV Data Loading active

## 2025-05-18 3:22 PM — Task 5 (Git LFS / CSV Data Loading)
**[test]** Test load_data() with and without CSV present
...
## 2025-05-23 1:28 PM — Task 2 (Data Augmentation)
**[test]** Assert augmented tensors stay in [0,1] range

## 2025-05-23 1:44 PM — Task 2 (Data Augmentation)
**[debug]** Fix AUTOTUNE bottleneck if augmentation slows pipeline

## 2025-05-23 6:07 PM — Task 2 (Data Augmentation)
...
## 2025-05-27 8:03 AM — Task 6 (tf.data Pipeline)
**[Plan]** Review Task 6 (tf.data Pipeline) requirements and acceptance criteria

## 2025-05-27 8:44 AM — Task 6 (tf.data Pipeline)
**[Setup]** Create/open relevant files for tf.data Pipeline implementation

## 2025-05-27 8:07 PM — Task 6 (tf.data Pipeline)
**[Test]** Write stub test for tf.data Pipeline to define expected behavior

## 2025-05-27 8:19 PM — Task 6 (tf.data Pipeline)
**[Debug]** Verify dev environment: imports, paths, configs for tf.data Pipeline
...
## 2025-05-30 7:19 PM — Task 6 (tf.data Pipeline)
**[debug]** Resolve TF graph tracing error from Python loops inside map()

## 2025-05-30 10:02 PM — Task 6 (tf.data Pipeline)
**[evaluate]** Profile pipeline with tf.profiler to find bottleneck
...
## 2025-06-01 9:41 AM — Task 6 (tf.data Pipeline)
**[Test]** Run integration test: main.py with tf.data Pipeline active

## 2025-06-01 11:02 AM — Task 6 (tf.data Pipeline)
**[test]** Benchmark throughput: steps/sec with and without pipeline

## 2025-06-01 12:44 PM — Task 6 (tf.data Pipeline)
**[debug]** Fix OOM error if shuffle buffer too large for RAM

## 2025-06-01 4:13 PM — Task 6 (tf.data Pipeline)
**[debug]** Resolve TF graph tracing error from Python loops inside map()
...
## 2025-06-04 6:37 PM — Task 6 (tf.data Pipeline)
**[Review]** Review Task 6 output against ROADMAP acceptance criteria

## 2025-06-04 7:03 PM — Task 6 (tf.data Pipeline)
**[Docs]** Add Task 6 entry to CHANGELOG.md

## 2025-06-04 8:07 PM — Task 6 (tf.data Pipeline)
**[Evaluate]** Log Task 6 final metrics/results to REPORT.md

## 2025-06-04 11:03 PM — Task 6 (tf.data Pipeline)
**[Debug]** Re-test edge cases after latest changes to tf.data Pipeline

## 2025-06-04 11:19 PM — Task 6 (tf.data Pipeline)
**[Test]** Add parametrized pytest case for tf.data Pipeline boundary conditions
...
## 2025-06-05 1:07 PM — Task 7 (Visualize Augmented Samples)
**[notebook]** Call visualize_augmented_batch and inspect output

## 2025-06-05 3:47 PM — Task 7 (Visualize Augmented Samples)
...
## 2025-06-06 5:38 PM — Task 7 (Visualize Augmented Samples)
**[Docs]** Update inline comments in modified files for Visualize Augmented Samples

## 2025-06-06 6:07 PM — Task 7 (Visualize Augmented Samples)
**[Review]** Cross-check Visualize Augmented Samples behavior against expected spec
...
## 2025-06-10 11:02 AM — Task 8 (Per-channel Standardization)
**[evaluate]** Compare model accuracy: normalised vs standardised

## 2025-06-10 2:33 PM — Task 8 (Per-channel Standardization)
**[docs]** Note: reuse training stats for val/test sets
...
## 2025-06-12 7:19 PM — Task 38 (Refactor to Python Modules)
**[Debug]** Re-test edge cases after latest changes to Refactor to Python Modules

## 2025-06-12 7:53 PM — Task 38 (Refactor to Python Modules)
**[Test]** Add parametrized pytest case for Refactor to Python Modules boundary conditions
...
## 2025-06-13 9:14 AM — Task 38 (Refactor to Python Modules)
**[Plan]** Review Task 38 (Refactor to Python Modules) requirements and acceptance criteria
...
## 2025-06-13 1:19 PM — Task 38 (Refactor to Python Modules)
**[Test]** Write stub test for Refactor to Python Modules to define expected behavior

## 2025-06-13 4:13 PM — Task 38 (Refactor to Python Modules)
**[Debug]** Verify dev environment: imports, paths, configs for Refactor to Python Modules

## 2025-06-13 7:44 PM — Task 38 (Refactor to Python Modules)
**[Debug]** Re-test edge cases after latest changes to Refactor to Python Modules

## 2025-06-13 7:53 PM — Task 38 (Refactor to Python Modules)
**[Review]** Cross-check Refactor to Python Modules behavior against expected spec
...
## 2025-06-15 3:47 PM — Task 38 (Refactor to Python Modules)
**[evaluate.py]** Move all evaluation/plotting functions to evaluate.py

## 2025-06-15 4:47 PM — Task 38 (Refactor to Python Modules)
...
## 2025-06-20 11:13 AM — Task 38 (Refactor to Python Modules)
**[Debug]** Resolve any final issues flagged in Task 38 test run

## 2025-06-20 11:52 AM — Task 38 (Refactor to Python Modules)
**[Commit]** Commit Task 38 (Refactor to Python Modules) with passing tests

## 2025-06-20 12:07 PM — Task 38 (Refactor to Python Modules)
**[Review]** Review Task 38 output against ROADMAP acceptance criteria

## 2025-06-20 1:44 PM — Task 38 (Refactor to Python Modules)
**[Docs]** Add Task 38 entry to CHANGELOG.md

## 2025-06-20 5:03 PM — Task 38 (Refactor to Python Modules)
**[Evaluate]** Log Task 38 final metrics/results to REPORT.md
...
## 2025-06-21 4:28 PM — Task 41 (Unit Tests with pytest)
...
## 2025-06-22 5:03 PM — Task 41 (Unit Tests with pytest)
...
## 2025-06-23 11:13 AM — Task 41 (Unit Tests with pytest)
**[tests/]** Write test_evaluate.py: test confusion matrix shape, AUC range

## 2025-06-23 1:19 PM — Task 41 (Unit Tests with pytest)
**[test]** Run pytest tests/ and assert all tests pass

## 2025-06-23 3:22 PM — Task 41 (Unit Tests with pytest)
**[debug]** Fix fixture scope error if TF session not reset between tests
...
## 2025-06-25 10:47 PM — Task 41 (Unit Tests with pytest)
**[Debug]** Re-test edge cases after latest changes to Unit Tests with pytest
...
## 2025-07-05 6:37 PM — Task 10 (Batch Normalization)
**[Test]** Write stub test for Batch Normalization to define expected behavior

## 2025-07-06 9:23 AM — Task 10 (Batch Normalization)
**[Plan]** Review Task 10 (Batch Normalization) requirements and acceptance criteria

## 2025-07-06 9:28 AM — Task 10 (Batch Normalization)
**[Setup]** Create/open relevant files for Batch Normalization implementation
...
## 2025-07-07 3:47 PM — Task 10 (Batch Normalization)
**[notebook]** Compare training curves: with BN vs without BN

## 2025-07-07 4:28 PM — Task 10 (Batch Normalization)
...
## 2025-07-07 9:23 PM — Task 10 (Batch Normalization)
**[evaluate]** Check if BN improves convergence speed vs baseline

## 2025-07-07 10:17 PM — Task 10 (Batch Normalization)
**[docs]** Comment placement rationale in model.py

## 2025-07-07 11:45 PM — Task 10 (Batch Normalization)
...
## 2025-07-08 4:02 PM — Task 10 (Batch Normalization)
**[debug]** Fix BN training=False not applied during inference

## 2025-07-08 4:28 PM — Task 10 (Batch Normalization)
**[debug]** Handle NaN loss from BN + high LR combination

## 2025-07-08 5:53 PM — Task 10 (Batch Normalization)
**[evaluate]** Check if BN improves convergence speed vs baseline
...
## 2025-07-09 9:28 AM — Task 10 (Batch Normalization)
...
## 2025-07-09 1:44 PM — Task 10 (Batch Normalization)
**[debug]** Handle NaN loss from BN + high LR combination
...
## 2025-07-10 3:47 PM — Task 10 (Batch Normalization)
**[docs]** Comment placement rationale in model.py

## 2025-07-10 4:13 PM — Task 10 (Batch Normalization)
**[Error]** Add try/except around Batch Normalization critical path with fallback

## 2025-07-10 4:28 PM — Task 10 (Batch Normalization)
**[Debug]** Profile Batch Normalization for speed/memory regressions
...
## 2025-07-11 7:53 PM — Task 10 (Batch Normalization)
**[Review]** Cross-check Batch Normalization behavior against expected spec

## 2025-07-11 8:07 PM — Task 10 (Batch Normalization)
**[Evaluate]** Re-run evaluation metrics after Batch Normalization fix
...
## 2025-07-12 11:52 AM — Task 11 (Deeper 4-Block CNN)
...
## 2025-07-14 2:44 PM — Task 11 (Deeper 4-Block CNN)
...
## 2025-07-15 11:37 AM — Task 11 (Deeper 4-Block CNN)
**[docs]** Add architecture diagram in ASCII to model.py docstring
...
## 2025-07-16 3:38 PM — Task 11 (Deeper 4-Block CNN)
**[debug]** Fix spatial dims collapse (output 0x0) if MaxPool applied too many times

## 2025-07-16 4:28 PM — Task 11 (Deeper 4-Block CNN)
**[evaluate]** Compare: 2-block vs 3-block vs 4-block val accuracy table

## 2025-07-16 5:03 PM — Task 11 (Deeper 4-Block CNN)
**[docs]** Add architecture diagram in ASCII to model.py docstring

## 2025-07-16 5:19 PM — Task 11 (Deeper 4-Block CNN)
...
## 2025-07-17 2:44 PM — Task 11 (Deeper 4-Block CNN)
**[test]** Assert model has 4 MaxPooling2D layers

## 2025-07-17 3:22 PM — Task 11 (Deeper 4-Block CNN)
**[debug]** Fix spatial dims collapse (output 0x0) if MaxPool applied too many times

## 2025-07-17 3:47 PM — Task 11 (Deeper 4-Block CNN)
**[evaluate]** Compare: 2-block vs 3-block vs 4-block val accuracy table
...
## 2025-07-20 8:37 AM — Task 14 (Wider Filters 5x5)
**[Plan]** Review Task 14 (Wider Filters 5x5) requirements and acceptance criteria

## 2025-07-20 9:23 AM — Task 14 (Wider Filters 5x5)
**[Setup]** Create/open relevant files for Wider Filters 5x5 implementation

## 2025-07-20 4:47 PM — Task 14 (Wider Filters 5x5)
**[test]** Assert first Conv2D has kernel_size (5,5) in 5x5 model

## 2025-07-20 6:07 PM — Task 14 (Wider Filters 5x5)
**[Test]** Write stub test for Wider Filters 5x5 to define expected behavior

## 2025-07-21 11:37 AM — Task 14 (Wider Filters 5x5)
**[test]** Assert first Conv2D has kernel_size (5,5) in 5x5 model

## 2025-07-21 1:19 PM — Task 14 (Wider Filters 5x5)
**[debug]** Fix memory overflow if 5x5 kernels on 28x28 images too deep

## 2025-07-21 1:44 PM — Task 14 (Wider Filters 5x5)
...
## 2025-07-22 11:02 AM — Task 14 (Wider Filters 5x5)
**[docs]** Note texture vs edge detection trade-off in docstring

## 2025-07-22 2:53 PM — Task 14 (Wider Filters 5x5)
**[Test]** Run unit tests for Wider Filters 5x5; fix failures
...
## 2025-07-23 2:03 PM — Task 14 (Wider Filters 5x5)
**[test]** Assert first Conv2D has kernel_size (5,5) in 5x5 model

## 2025-07-23 2:17 PM — Task 14 (Wider Filters 5x5)
**[debug]** Fix memory overflow if 5x5 kernels on 28x28 images too deep
...
## 2025-07-27 6:22 PM — Task 15 (Global Average Pooling)
**[test]** Assert model has GlobalAveragePooling2D and no Flatten layer

## 2025-07-28 3:22 PM — Task 15 (Global Average Pooling)
**[test]** Assert model has GlobalAveragePooling2D and no Flatten layer

## 2025-07-28 3:47 PM — Task 15 (Global Average Pooling)
...
## 2025-07-29 2:53 PM — Task 15 (Global Average Pooling)
**[docs]** Document GAP advantages: fewer params, spatial average

## 2025-07-29 3:22 PM — Task 15 (Global Average Pooling)
**[Test]** Run unit tests for Global Average Pooling; fix failures
...
## 2025-07-30 3:47 PM — Task 15 (Global Average Pooling)
**[test]** Assert model has GlobalAveragePooling2D and no Flatten layer
...
## 2025-07-31 3:07 PM — Task 15 (Global Average Pooling)
**[evaluate]** Compare GAP vs Flatten: accuracy, params, inference latency
...
## 2025-08-02 5:19 PM — Task 16 (VGG-style Architecture)
...
## 2025-08-04 2:03 PM — Task 16 (VGG-style Architecture)
**[test]** Assert model has 6 Conv2D layers total

## 2025-08-04 3:47 PM — Task 16 (VGG-style Architecture)
**[debug]** Fix slow training caused by large Dense(512) layer

## 2025-08-04 4:47 PM — Task 16 (VGG-style Architecture)
...
## 2025-08-05 4:13 PM — Task 16 (VGG-style Architecture)
**[evaluate]** Compare VGG-style vs deep CNN vs ResNet on val accuracy
...
## 2025-08-06 11:03 PM — Task 16 (VGG-style Architecture)
**[Test]** Edge-case test: VGG-style Architecture with empty/corrupt/extreme inputs

## 2025-08-06 11:37 PM — Task 16 (VGG-style Architecture)
**[Review]** Cross-check VGG-style Architecture behavior against expected spec

## 2025-08-07 8:03 AM — Task 16 (VGG-style Architecture)
**[Integrate]** Wire VGG-style Architecture into main.py pipeline end-to-end

## 2025-08-07 11:02 AM — Task 16 (VGG-style Architecture)
**[Test]** Run integration test: main.py with VGG-style Architecture active

## 2025-08-07 4:47 PM — Task 16 (VGG-style Architecture)
**[test]** Assert model has 6 Conv2D layers total
...
## 2025-08-10 10:28 AM — Task 25 (Optimizer Comparison)
**[Setup]** Create/open relevant files for Optimizer Comparison implementation

## 2025-08-10 2:44 PM — Task 25 (Optimizer Comparison)
**[evaluate]** Build comparison table: optimizer vs val_acc vs convergence_epoch

## 2025-08-10 2:53 PM — Task 25 (Optimizer Comparison)
**[test]** Assert get_optimizer raises ValueError for unknown name
...
## 2025-08-12 1:44 PM — Task 25 (Optimizer Comparison)
**[evaluate]** Plot overlaid training curves for all optimizers
...
## 2025-08-21 4:47 PM — Task 27 (Batch Size Experiments)
**[debug]** Fix OOM error for batch=256 by reducing model complexity
...
## 2025-08-25 1:19 PM — Task 28 (L2 Regularization)
**[debug]** Tune L2 weight if validation loss increases instead of smoothing

## 2025-08-25 2:03 PM — Task 28 (L2 Regularization)
**[evaluate]** Compare val curves with L2 vs without to confirm regularization effect
...
## 2025-08-26 4:02 PM — Task 28 (L2 Regularization)
**[debug]** Tune L2 weight if validation loss increases instead of smoothing
...
## 2025-08-28 2:53 PM — Task 33 (ROC-AUC Analysis)
**[evaluate.py]** Write plot_roc_curves(y_true_oh, y_pred_prob, class_names, save_path)

## 2025-08-28 3:38 PM — Task 33 (ROC-AUC Analysis)
...
## 2025-08-29 2:53 PM — Task 33 (ROC-AUC Analysis)
...
## 2025-08-31 12:44 PM — Task 33 (ROC-AUC Analysis)
**[debug]** Fix ValueError if y_true not one-hot encoded for multiclass
...
## 2025-09-02 9:23 AM — Task 34 (Calibration Analysis)
**[evaluate.py]** Use sklearn.calibration.calibration_curve per class

## 2025-09-02 1:28 PM — Task 34 (Calibration Analysis)
...
## 2025-09-04 7:03 PM — Task 34 (Calibration Analysis)
**[Test]** Run unit tests for Calibration Analysis; fix failures
...
## 2025-09-04 11:45 PM — Task 34 (Calibration Analysis)
**[Evaluate]** Re-run evaluation metrics after Calibration Analysis fix
...
## 2025-09-05 2:44 PM — Task 34 (Calibration Analysis)
**[evaluate]** Compare calibration: baseline vs label-smoothed model
...
## 2025-09-08 9:07 AM — Task 9 (Resize Images to 32x32 for Transfer Learning)
**[Setup]** Create/open relevant files for Resize Images to 32x32 for Transfer Learning implementation

## 2025-09-08 1:19 PM — Task 9 (Resize Images to 32x32 for Transfer Learning)
**[test]** Assert output shape (None, 32, 32, 3)

## 2025-09-08 2:17 PM — Task 9 (Resize Images to 32x32 for Transfer Learning)
**[Test]** Write stub test for Resize Images to 32x32 for Transfer Learning to define expected behavior
...
## 2025-09-09 2:17 PM — Task 9 (Resize Images to 32x32 for Transfer Learning)
...
## 2025-09-10 3:22 PM — Task 9 (Resize Images to 32x32 for Transfer Learning)
**[evaluate]** Verify transfer-learning model accepts resized input
...
## 2025-09-10 6:37 PM — Task 9 (Resize Images to 32x32 for Transfer Learning)
...
## 2025-09-11 4:28 PM — Task 9 (Resize Images to 32x32 for Transfer Learning)
**[debug]** Fix aliasing artifacts if bilinear resize distorts fashion textures
...
## 2025-09-26 5:38 PM — Task 21 (LR Scheduler: Cosine Annealing & Warmup)
**[test]** Assert LR at step 0 is warmup_start_lr and step N is min_lr
...
## 2025-09-29 2:33 PM — Task 29 (Mixed-Precision Training (float16))
...
## 2025-09-29 8:44 PM — Task 29 (Mixed-Precision Training (float16))
**[Debug]** Re-test edge cases after latest changes to Mixed-Precision Training (float16)
...
## 2025-09-30 8:52 AM — Task 29 (Mixed-Precision Training (float16))
**[Setup]** Create/open relevant files for Mixed-Precision Training (float16) implementation
...
## 2025-09-30 11:03 PM — Task 29 (Mixed-Precision Training (float16))
**[Debug]** Verify dev environment: imports, paths, configs for Mixed-Precision Training (float16)
...
## 2025-10-01 12:33 PM — Task 29 (Mixed-Precision Training (float16))
**[debug]** Resolve 'Unsupported dtype float16' error in BN on older TF

## 2025-10-01 1:19 PM — Task 29 (Mixed-Precision Training (float16))
**[debug]** Handle GPU not supporting float16: add device capability check

## 2025-10-01 2:53 PM — Task 29 (Mixed-Precision Training (float16))
...
## 2025-10-01 7:28 PM — Task 29 (Mixed-Precision Training (float16))
**[Debug]** Inspect shapes/types/values in Mixed-Precision Training (float16) pipeline step

## 2025-10-01 8:19 PM — Task 29 (Mixed-Precision Training (float16))
**[Review]** Code-review Mixed-Precision Training (float16) implementation for edge cases

## 2025-10-02 2:53 PM — Task 29 (Mixed-Precision Training (float16))
**[test]** Assert policy name is 'mixed_float16' after setting

## 2025-10-02 3:22 PM — Task 29 (Mixed-Precision Training (float16))
**[debug]** Fix NaN loss from float16 underflow: increase loss scale factor

## 2025-10-02 3:47 PM — Task 29 (Mixed-Precision Training (float16))
**[debug]** Resolve 'Unsupported dtype float16' error in BN on older TF
...
## 2025-10-03 5:19 PM — Task 29 (Mixed-Precision Training (float16))
**[evaluate]** Measure speedup: float32 vs float16 training steps/sec

## 2025-10-03 5:53 PM — Task 29 (Mixed-Precision Training (float16))
**[docs]** Add compatibility note for CPU-only environments in train.py

## 2025-10-03 7:19 PM — Task 29 (Mixed-Precision Training (float16))
**[Test]** Run unit tests for Mixed-Precision Training (float16); fix failures
...
## 2025-10-04 1:19 PM — Task 29 (Mixed-Precision Training (float16))
**[debug]** Resolve 'Unsupported dtype float16' error in BN on older TF

## 2025-10-04 5:53 PM — Task 29 (Mixed-Precision Training (float16))
**[debug]** Handle GPU not supporting float16: add device capability check

## 2025-10-05 8:52 AM — Task 29 (Mixed-Precision Training (float16))
...
## 2025-10-07 2:53 PM — Task 35 (Inference Speed Benchmarking)
...
## 2025-10-10 12:07 PM — Task 35 (Inference Speed Benchmarking)
...
## 2025-10-11 4:47 PM — Task 35 (Inference Speed Benchmarking)
**[debug]** Fix warm-up effect: skip first 5 runs from timing average
...
## 2025-10-13 6:07 PM — Task 36 (Robustness Testing)
...
## 2025-10-14 12:33 PM — Task 36 (Robustness Testing)
**[evaluate.py]** Write add_blur(images, sigma=1.0) using scipy.ndimage.gaussian_filter
...
## 2025-10-15 4:28 PM — Task 36 (Robustness Testing)
**[evaluate.py]** Test each model under noise, blur, brightness perturbations
...
## 2025-10-16 5:53 PM — Task 36 (Robustness Testing)
**[docs]** Save robustness results to results/robustness_{model_name}.csv

## 2025-10-16 6:07 PM — Task 36 (Robustness Testing)
**[Test]** Run unit tests for Robustness Testing; fix failures
...
## 2025-10-17 12:44 PM — Task 36 (Robustness Testing)
**[test]** Assert corrupted images remain in valid pixel range [0,1]

## 2025-10-17 1:28 PM — Task 36 (Robustness Testing)
**[debug]** Fix clipping overflow in brightness_shift for max pixel values
...
## 2025-11-01 10:07 AM — Task 44 (Export to TensorFlow SavedModel)
...
## 2025-11-02 12:18 PM — Task 44 (Export to TensorFlow SavedModel)
**[Test]** Write stub test for Export to TensorFlow SavedModel to define expected behavior

## 2025-11-02 5:03 PM — Task 44 (Export to TensorFlow SavedModel)
**[Debug]** Verify dev environment: imports, paths, configs for Export to TensorFlow SavedModel

## 2025-11-03 1:44 PM — Task 44 (Export to TensorFlow SavedModel)
**[test]** Assert saved_model.pb exists in export directory

## 2025-11-03 2:03 PM — Task 44 (Export to TensorFlow SavedModel)
**[debug]** Fix SavedModel export failure from Lambda layers in model

## 2025-11-03 2:17 PM — Task 44 (Export to TensorFlow SavedModel)
...
## 2025-11-04 7:44 PM — Task 44 (Export to TensorFlow SavedModel)
**[evaluate]** Assert identical predictions from Keras vs SavedModel

## 2025-11-04 11:37 PM — Task 44 (Export to TensorFlow SavedModel)
**[docs]** Document export directory structure in export.py docstring
...
## 2025-11-06 12:44 PM — Task 44 (Export to TensorFlow SavedModel)
**[test]** Assert saved_model.pb exists in export directory

## 2025-11-06 2:03 PM — Task 44 (Export to TensorFlow SavedModel)
**[debug]** Fix SavedModel export failure from Lambda layers in model
...
## 2025-12-13 10:07 AM — Task 46 (predict.py Inference Script)
**[Setup]** Create/open relevant files for predict.py Inference Script implementation
...
## 2025-12-15 2:33 PM — Task 46 (predict.py Inference Script)
**[debug]** Fix PIL vs TF image channel ordering (RGB vs BGR) mismatch

## 2025-12-15 3:47 PM — Task 46 (predict.py Inference Script)
...
## 2025-12-16 6:22 PM — Task 46 (predict.py Inference Script)
**[docs]** Add usage examples to predict.py docstring and README.md
...
## 2025-12-19 4:13 PM — Task 46 (predict.py Inference Script)
**[Review]** Review Task 46 output against ROADMAP acceptance criteria
